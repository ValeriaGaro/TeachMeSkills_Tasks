...
vap_xros = Electronic_Cigarettes("Vaporesso XROS", 16, 16513216)
vap_barr = Electronic_Cigarettes("Vaporesso Barr", 13, 15644424)
elf = Electronic_Cigarettes("Elf Bar", 12, 19849652)

print(vap_xros)
print(Electronic_Cigarettes.compare_power(vap_barr, elf))
